...
$pluginManifest = Get-Content -Raw (Join-Path $repoRoot "companion_plugin/manifest.json") | ConvertFrom-Json
...
if (-not (Test-Path -LiteralPath (Join-Path $repoRoot "companion_plugin/main.js"))) {
  throw "Built companion_plugin/main.js is missing. Run npm run build first."
}
...
Copy-Item -LiteralPath (Join-Path $repoRoot "companion_plugin/main.js") -Destination $pluginSource -Force
Copy-Item -LiteralPath (Join-Path $repoRoot "companion_plugin/manifest.json") -Destination $pluginSource -Force
Copy-Item -LiteralPath (Join-Path $repoRoot "companion_plugin/styles.css") -Destination $pluginSource -Force
